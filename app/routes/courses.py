...
# ---------------------------------------------------------------------------
# DEBUG endpoints â see raw API response to fix field mapping
# ---------------------------------------------------------------------------
...
def search_courses():
    ...
    try:
        ...
        # (e.g. "foxhill" â "foxhi" finds "Foxhills"). Merge, dedup by id+name.
    ...
    # Supplement with locally cached courses â catches previously searched courses
    ...
    # ââ Country priority ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
    ...
    # ââ Fuzzy scoring ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
# ---------------------------------------------------------------------------
# Tees â fetch + cache on first request, serve from DB thereafter
# ---------------------------------------------------------------------------
...
def get_tees(external_id: str):
    ...
    Tees are returned even when the API provides no hole-by-hole data â
    ...
    # Require at least one tee â if the API gave us nothing, bail clearly
    if not api_tees:
